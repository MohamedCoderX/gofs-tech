...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        " bg-gradient-to-b from-black to-neutral-800 pb-10 mt-10 dark:from-neutral-950 dark:to-neutral-800 relative items-center w-full justify-center overflow-hidden",
